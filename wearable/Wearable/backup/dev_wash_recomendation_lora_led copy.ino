...
void loop(){
    ...
    if(state == WAITING){
        ...
        if(num_recommend_wash == 2){
            // feedbackPlay(RECOMMEND_WASH_MP3_2);
        ...
        if( !washed && cur_act == WASH){    // 손을 씻은 것을 처음 감지함
            ...
            SPI_toVS1053();
            delay(10);
            musicPlayer.playFullFile(DETECT_WASH_MP3);
            ...
            SPI_toVS1053();
            delay(10);
            musicPlayer.playFullFile(DETECT_END_WASH_MP3);
          
            LoRa_sendResult((uint8_t*)"1");
            
            Serial.println("잘 씻었어 이제 밥 먹자");
            ...
            SPI_toVS1053();
            delay(10);
            musicPlayer.playFullFile(NOT_WASH_EAT_DETECT_MP3);
        ...
        if(num_recommend_brush == 2){
            ShowLed(FROWN ,led_matrix);
            // feedbackPlay(NOT_WASH_EAT_DETECT_MP3);
